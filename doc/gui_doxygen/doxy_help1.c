...
// get all directories out of envVar srcDirs
  ...
  // get directories
  s1 = getenv("srcDirs");
  if(!s1) {printf("******** do_dirs1 E001\n"); return -1;}

  // copy 
  s2 = alloca (strlen(s1) + 64);
  strcpy (s2, s1);
  // separate words
  p1 = s2;
    printf("sDir=|%s|\n",p1);
...
//================================================================
// get all files in a directory actDir out of list of files (?)
